...
export const projectsData = [
  {
    ...
    info: 'At Taboola I started as an Impl Dev and advanced to a Solution Engineer role. I Oversaw the technical integrations of web and SDK code with high profile publishers from pre-sales stages to launch. I was also heavily involved with the development side- working exclusively with Javascript, HTML and CSS to find creative solutions for top tier clients.',
    info2: '',
  ...
  },
  {
    ...
    info: 'A web application that utilizes the IEX Cloud API to retrieve stock data and simulate a stock trading application. It was developed using React JS, Node.js, PostgresSQL and styled with Bootstrap.',
  ...
  },
  {
    ...
    info: 'This web app utilizes Twitter\'\s APIs to allow users to search recent tweets of their favorite people, whilst not logging in to twitter.com. Users may also search for random tweets.',
